...
func update_ui(recipe: Array[Ingredient.IngredientType], collected: Array[bool]):
...
func _on_witch_on_recipe_update(recipe: Array[Ingredient.IngredientType], collected: Array[bool]):
